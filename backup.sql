...
--
-- Host: localhost    Database: iamdbg
-- ------------------------------------------------------
...
CREATE TABLE `ogrenciler` (
  ...
  `sinif` int(10) unsigned NOT NULL DEFAULT '1',
  PRIMARY KEY (`ogr_ID`)
...
INSERT INTO `ogrenciler` VALUES (111111110,'Ahmet','Yürekli',3);
...
-- Dump completed on 2019-04-12 23:17:50
